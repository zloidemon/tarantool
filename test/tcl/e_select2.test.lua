...
do_execsql_test e_select-2.0 {
  CREATE TABLE t1(idt1 primary key, a, b);
  CREATE TABLE t2(idt2 primary key, a, b);
  CREATE TABLE t3(idt3 primary key, b COLLATE nocase);

  INSERT INTO t1 VALUES(1, 2, 'B');
  INSERT INTO t1 VALUES(2, 1, 'A');
  INSERT INTO t1 VALUES(3, 4, 'D');
  INSERT INTO t1 VALUES(4, NULL, NULL);
  INSERT INTO t1 VALUES(5, 3, NULL);

  INSERT INTO t2 VALUES(1, 1, 'A');
  INSERT INTO t2 VALUES(2, 2, NULL);
  INSERT INTO t2 VALUES(3, 5, 'E');
  INSERT INTO t2 VALUES(4, NULL, NULL);
  INSERT INTO t2 VALUES(5, 3, 'C');
...
do_execsql_test e_select-2.2.0 {
  CREATE TABLE t4(idt4 primary key, x TEXT COLLATE nocase);
  CREATE TABLE t5(idt5 primary key, y INTEGER, z TEXT COLLATE binary);

  INSERT INTO t4 VALUES(1, '2.0');
  INSERT INTO t4 VALUES(2, 'TWO');
  INSERT INTO t5 VALUES(1, 2, 'two');
} {}
