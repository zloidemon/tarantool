...
#
do_test insert2-1.0 {
  execsql {CREATE TABLE d1(n int primary key, log int);}
...
do_test insert2-1.1.1 {
  execsql {
    CREATE TABLE t1(log int primary key, cnt int);
...
#       CREATE TEMPORARY TABLE DepCheck(troveId INT primary key, depNum INT,
