...
#   execsql {
#     CREATE TABLE abc(b primary key);
...
#   execsql {
#     CREATE TABLE abc(a primary key, b, c);
#     CREATE TABLE def(a primary key, b, c);
#     CREATE TABLE ghi(a primary key, b, c);
#   }
# } {}
# do_test fuzz-1.16.2 {
#   catchsql {
...
# # 
# do_test fuzz-1.19 {
#   execsql { CREATE TABLE t1(id primary key, a) }
#   catchsql {
...
# do_test fuzz-3.1 {
#   execsql {
#     CREATE TABLE abc(a, b, c, primary key(a,b,c));
#     CREATE TABLE def(a, b, c, primary key(c,a,b));
#     CREATE TABLE ghi(a, b, c, primary key(b,c,a));
#   }
# } {}
