...
do_test enc-11.1 {
  execsql {
    CREATE TABLE ab(id primary key, a COLLATE test_collate, b);
    INSERT INTO ab VALUES(1, CAST (X'C388' AS TEXT), X'888800');
    INSERT INTO ab VALUES(2, CAST (X'C0808080808080808080808080808080808080808080808080808080808080808080808080808080808080808080808080808080808388' AS TEXT), X'888800');
