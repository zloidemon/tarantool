...
execsql {CREATE TABLE test1(f1 int, f2 int, PRIMARY KEY(f1))}
...
execsql {CREATE TABLE test2(r1 int, r2 int, PRIMARY KEY(r1))}
execsql {INSERT INTO test2(r1,r2) VALUES(1,2)}
...
do_test select1-2.0 {
  execsql "
    ...
    INSERT INTO t4 VALUES(1, NULL,'$long');
    SELECT * FROM t3;
  "
...
execsql { DROP TABLE IF EXISTS test2 }
execsql {CREATE TABLE test2(t1 text primary key, t2 text)}
