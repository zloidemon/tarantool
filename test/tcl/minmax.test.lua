...
do_test minmax-10.9 {
  execsql {
    INSERT INTO t6 SELECT id+3,x FROM t6;
    INSERT INTO t6 SELECT id+6,x FROM t6;
    INSERT INTO t6 SELECT id+12,x FROM t6;
    INSERT INTO t6 SELECT id+24,x FROM t6;
    INSERT INTO t6 SELECT id+48,x FROM t6;
    INSERT INTO t6 SELECT id+96,x FROM t6;
    INSERT INTO t6 SELECT id+192,x FROM t6;
    INSERT INTO t6 SELECT id+400,x FROM t6;
    INSERT INTO t6 SELECT id+800,x FROM t6;
    INSERT INTO t6 SELECT id+1600,x FROM t6;
    SELECT count(*) FROM t6;
  }
} 1024
...
do_execsql_test 13.1 {
  ...
  INSERT INTO t1 VALUES(2, 'b', 6, 6);
  INSERT INTO t1 VALUES(3, 'c', 5, 5);
  INSERT INTO t1 VALUES(4, 'a', 4, 4);
  INSERT INTO t1 VALUES(5, 'a', 5, 5);
  INSERT INTO t1 VALUES(6, 'c', 6, 6);
  INSERT INTO t1 VALUES(7, 'b', 4, 4);
  INSERT INTO t1 VALUES(8, 'c', 7, 7);
  INSERT INTO t1 VALUES(9, 'b', 2, 2);
  INSERT INTO t1 VALUES(10, 'b', 3, 3);
  INSERT INTO t1 VALUES(11, 'a', 3, 3);
  INSERT INTO t1 VALUES(12, 'b', 5, 5);
  INSERT INTO t1 VALUES(13, 'c', 4, 4);
  INSERT INTO t1 VALUES(14, 'c', 3, 3);
  INSERT INTO t1 VALUES(15, 'a', 2, 2);
