...
for {set i 1} {$i<=32} {incr i} {
  ...
  execsql "INSERT INTO t1 VALUES($i, [expr {32-$i}],[expr {10-$j}])"
}
execsql {
  COMMIT;
}
...
do_test limit-1.6 {
  execsql {SELECT a.x,a.y,b.x,b.y FROM t1 AS a, t1 AS b ORDER BY a.x, b.x LIMIT 5}
} {0 5 0 5 0 5 1 5 0 5 2 5 0 5 3 5 0 5 4 5}
do_test limit-1.7 {
  execsql {SELECT a.x,a.y,b.x,b.y FROM t1 AS a, t1 AS b ORDER BY a.x, b.x LIMIT 5 OFFSET 32}
