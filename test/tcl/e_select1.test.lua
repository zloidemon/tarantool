...
do_join_test e_select-1.4.2.1 {
  SELECT c,d,e,f,g,h,i FROM x2 %JOIN% x3 ORDER BY +c, +f
...
do_test e_select-1.4.3.2 { 
  expr {[llength [execsql {SELECT a,b,c,d,e FROM x1, x2}]] / 6}
} [expr 2+3]
...
do_test e_select-1.4.3.4 { 
  expr {[llength [execsql {SELECT c,d,e,f,g,h,i FROM x2 JOIN x3}]] / 10}
} [expr 3+4]
...
do_test e_select-1.4.3.6 { 
  expr {[llength [execsql {SELECT f,g,h,i,a,b FROM x3 CROSS JOIN x1}]] / 15}
} [expr 4+2]
...
do_test e_select-1.4.3.8 { 
  expr {[llength [execsql {SELECT x3.f,x3.g,x3.h,x3.i,x4.f,x4.g,x4.h,x4.i FROM x3 INNER JOIN x3 AS x4}]] / 25}
} [expr 4+4]
...
do_select_tests e_select-7.4 {
  ...
  4   {SELECT d,e FROM q2 UNION ALL SELECT f,g FROM q3} 
...
do_select_tests e_select-7.7 {
  ...
  2   {SELECT d,e FROM q2 EXCEPT SELECT f,g FROM q3} 
